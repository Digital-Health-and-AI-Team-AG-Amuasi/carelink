...
@section('title', sprintf('View visit #%s for %s %s', $visit->id, $patient->first_name, $patient->last_name))

@section('action-links')
    <a class="kt-btn kt-btn-primary" href="{{ route('visits.conditions.create', $visit) }}">
                            ...
                            <div class="kt-scrollable-auto">
                                <table class="kt-table align-middle text-sm text-secondary-foreground">
                                    ...
                                    @foreach($conditions as $condition)
                                        <tr>
                                            <td>
                                                {{ $condition->short_diagnosis ? : $condition->diagnosis }}
                                            </td>
                                            <td class="py-2 text-end">
